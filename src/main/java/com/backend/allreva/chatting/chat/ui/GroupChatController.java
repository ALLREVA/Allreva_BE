...
import com.backend.allreva.chatting.chat.group_chat.command.application.GroupChatCommandService;
import com.backend.allreva.chatting.chat.group_chat.command.application.request.DeleteGroupChatRequest;
...
import com.backend.allreva.chatting.chat.query.GroupChatQueryService;
...
public class GroupChatController {
    ...
    public Response<RoomInfoDetail> findGroupChatInformation(
            @PathVariable("groupChatId") final Long groupChatId,
            @AuthMember final Member member
    ) {
        RoomInfoDetail response = groupChatQueryService.findGroupChatInfo(member.getId(), groupChatId);

...
import com.backend.allreva.chatting.chat.integration.model.chat_room.ChatRoomComparator;
...
public class MemberChatRoomDoc {
    ...
    public void deleteChatRoom(
        ...
        ChatRoomSummary summary = ChatRoomSummary.of(roomId, roomType);
        this.chatRoomSummaries.remove(summary);
    }

package com.backend.allreva.chatting.group_chat.ui;

import com.backend.allreva.auth.security.AuthMember;
import com.backend.allreva.chatting.group_chat.command.application.request.AddGroupChatRequest;
import com.backend.allreva.chatting.group_chat.command.application.GroupChatCommandService;
import com.backend.allreva.chatting.group_chat.command.application.request.DeleteGroupChatRequest;
import com.backend.allreva.chatting.group_chat.command.application.request.UpdateGroupChatRequest;
import com.backend.allreva.chatting.group_chat.query.GroupChatInfoResponse;
import com.backend.allreva.chatting.group_chat.query.GroupChatQueryService;
...
public class GroupChatController {
    ...
    public Response<GroupChatInfoResponse> findGroupChatInformation(
            @PathVariable("groupChatId") final Long groupChatId,
            @AuthMember final Member member
    ) {
        GroupChatInfoResponse response = groupChatQueryService.findGroupChatInfo(member.getId(), groupChatId);
